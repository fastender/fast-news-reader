...
PRESETS: list[Preset] = [
    ...
    _p("computerbase", "ComputerBase",
       "https://www.computerbase.de/rss/news.xml", CATEGORY_TECH, "de"),
    _p("winfuture", "WinFuture",
       "https://static.winfuture.de/feeds/WinFuture-News-rss2.0.xml",
       CATEGORY_TECH, "de"),
    _p("caschys", "Caschys Blog",
       "https://stadt-bremerhaven.de/feed/", CATEGORY_TECH, "de"),
    _p("ars", "Ars Technica",
